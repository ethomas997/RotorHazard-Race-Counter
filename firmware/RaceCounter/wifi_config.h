...
void   connectToWiFi();             // connect to the stored network; does not return until connected
void   startConfigAP();             // start the setup access point and its web page
void   checkClearAll();             // if both buttons are down: erase credentials + standalone flag and restart
